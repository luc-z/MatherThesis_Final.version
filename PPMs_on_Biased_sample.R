...
par(mfrow=c(1,2))
plot(ppp.lgcp, pch=20, cols="grey70", main= "Biased sample quadrat count")  # Plot points
...
#
##Excel
write_xlsx(lgcp.datap, "~/Biased_sample_117points.Data.xlsx")
str(lgcp.datap)

# Model formula
covar.sample.list <- list(Solar.radiation.sim=Solar.rad , Precipitation.sim=Preci, 
...
CPP.CLIK=envelope(fit.cox1, nsim = 200)
par(mfrow=c(1,2))
plot(CPP.CLIK)
graphics.off()
...
plot(prediction_cox.CLIK, main="CPP.CLIK prediction")
